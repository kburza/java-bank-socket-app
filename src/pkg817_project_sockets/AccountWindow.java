...
public class AccountWindow extends JFrame {
    ...
    public AccountWindow(Socket socket, String keyCS, String username, String clientID) {
        ...
        refreshButton.setBounds(150, 10, 140, 25);
        refreshButton.addActionListener(new RefreshButtonListener(socket, keyCS, clientID));
        add(refreshButton);
        ...
        transferLabel.setBounds(10, 130, 80, 25);
        add(transferLabel);

        transferNameField = new JTextField("username");
        transferNameField.setBounds(100, 130, 100, 25);
        add(transferNameField);
        
        transferAmountField = new JTextField("amount");
        transferAmountField.setBounds(100, 180, 100, 25);
        ...
        //
        JButton transferButton = new JButton("Submit");
        transferButton.setBounds(210, 180, 80, 25);
        transferButton.addActionListener(new transferButtonListener(socket, keyCS, clientID));
        add(transferButton);
        ...
        logoutButton.setBounds(210, 230, 80, 25);
    ...
    private class RefreshButtonListener implements ActionListener {
        ...
        private String keyCS;
        private String clientID;
        public RefreshButtonListener(Socket socket, String keyCS, String clientID) {
            this.socket = socket;
            this.keyCS = keyCS;
            this.clientID = clientID;
        }
    ...
    private class DepositButtonListener implements ActionListener {
        ...
        private String keyCS;
        private String clientID;
        public transferButtonListener(Socket socket, String keyCS, String clientID) {
            this.socket = socket;
            this.keyCS = keyCS;
            this.clientID = clientID;
        }
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            try {
                ...
                String msg = clientID+"&transfer&"+transferNameField.getText()+"&"+transferAmountField.getText();
                String encMsg = AES.encrypt(msg, keyCS);
                out.println(encMsg+"&"+calendar.getTimeInMillis());
