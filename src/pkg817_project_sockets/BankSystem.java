...
public class BankSystem {
    ...
    public double transfer(String sender, String recipient, double amount) {
        ...
        try {
            ...
            if (result.next()) {
                double recipientBalance = result.getDouble("balance");
                ...
                if (rs.next()) {
                    ...
                    if (newSenderBalance >= 0) {
                        ...
                        statement = conn.prepareStatement(sql);
                        statement.setDouble(1, newSenderBalance);
                        ...
                        sql = "UPDATE account SET balance = ? WHERE username = ?";
                        statement = conn.prepareStatement(sql);
                        statement.setDouble(1, newRecipientBalance);
                ...
                try {
                    if (file.exists()) {
                        ...
                        if (file.canWrite()) {
                            ...
                            SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
                            String dateString = dateFormat.format(new Date());
                            String log = sender + ", E-Transfer, " + dateString + ", " + amount + ", " + (senderBalance - amount) + "\n";
                            bw.write(log);
                            bw.close();
                            //System.out.println("Transaction logged successfully.");
                        } else {
                    ...
                    System.out.println("\nCould not retrieve balance for user " + sender);
                }
            } else {
