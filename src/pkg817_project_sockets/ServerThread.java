...
public class ServerThread extends Thread {
    ...
    public void run() {
        ...
        try ( 
           ...
           String decryptedMsg, encryptedMsg, recipient;
            ...
            while(true){
                if(in.ready()){
                    ...
                    if(action.equals("withdraw")){
                        ...
                        conn1 = new BankSystem();
                        System.out.println(decryptedList[2]);
                        System.out.println(decryptedList[3]);
                        recipient = decryptedList[2];
                        amount = Double.parseDouble(decryptedList[3]);
                        currBalance = conn1.transfer(userpass[0], recipient, amount);
                        encryptedMsg = AES.encrypt(Double.toString(currBalance), sharedPassword);
                        out.println(encryptedMsg);
                        conn1.closeConnection();
                    }
